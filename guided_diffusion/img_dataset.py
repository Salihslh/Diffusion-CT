...
class ImgDataset(torch.utils.data.Dataset):
    def __init__(self, path, resolution=256, test_flag=True):
        ...
        self._split = ["test" if self.test_flag else "train"]
        ...
        self._fnames = [
            fname for fname in self._all_fnames if self._file_ext(fname) == ".pickle" and self._st in fname
        ]
